...
|------------------------------+---------------------------------------------+---------------------------------------------------+-----------------+-----------------------------------------------------|
*** TODO go back to last position on a file
*** TODO move back and forward on what was opened
...
I'm a user of vim modal editing styles pretty much everywhere. I use evil in emacs.
...
| quotes parens matching   | included     |                        | electric-pair-mode |
|--------------------------+--------------+------------------------+--------------------|
